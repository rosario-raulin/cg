...
public:
  ...
  RAYTRACER_EXPORTS static bool linePlane(const Ray& ray, const Vec3d &a, const Vec3d &b,
  ...
  */
  ...
  RAYTRACER_EXPORTS static bool lineTriangle(const Ray& ray, const Vec3d &a, const Vec3d &b, const Vec3d &c, Vec3d& uvw, double & lambda)
  {
